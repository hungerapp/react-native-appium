Feature: Login Feature (existing)
  ...
  @regression @click_terms_and_conditions @login
  ...
  @regression  @login_invalid_email  @login
  ...
  @regression @login_unregistered_email @login
  ...
  @regression @login_invalid_verification_code @login
  ...
  @regression @login_modify_email @login
  ...
  @regression @login_existing @login
