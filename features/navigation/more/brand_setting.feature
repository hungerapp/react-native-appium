Feature: Brand Setting
  ...
  # MEMBER-APPLY_VOUCHER MANAGEMENT
  ...
  # MEMBER-APPLY_DOCUMENT MANAGEMENT
  ...
  # MEMBER-APPLY_BONUS POINT 
  @regression @bonus_point_in_member_apply
  ...
  # MEMBER-APPLY_CUSTOM MEMBERSHIP REGISTRATION
