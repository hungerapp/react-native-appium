Feature: Service Personnel Management
    ...
    Scenario: Add service personnel
        ...
        And I delete all service personnel
        ...
        And I add service personnel "服務人員<current_datetime>" and select color "1" and enter "robot_introduction<current_datetime>" and the Simultaneous Service Count "1"
