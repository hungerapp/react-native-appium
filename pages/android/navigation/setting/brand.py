...
class BrandPage:
    ...
    def verify_branch_settings_page(self):
        ...
        self.common_actions.is_element_visible(*self.brand_locators.BRANCH_SETTINGS_PAGE)
        return self
    ...
    def verify_branch_brand_info_page(self):
        self.driver.implicitly_wait(10)
        self.common_actions.is_element_visible(*self.brand_locators.TITLE_IN_BRANCH_BRAND_INFO_PAGE)
    ...
    def clear_branch_name(self):
        self.common_actions.clear_text(*self.brand_locators.BRANCH_NAME_FIELD_IN_BRANCH_BRAND_INFO_PAGE)
        return self

    def verify_error_message(self):
        self.common_actions.is_element_visible(*self.brand_locators.ERROR_MESSAGE_IN_BRANCH_BRAND_INFO_PAGE)
        return self
    ...
    def verify_branch_name(self, branch_name):
        self.common_actions.verify_element_text(*self.brand_locators.BRANCH_NAME_FIELD_IN_BRANCH_BRAND_INFO_PAGE, branch_name)
        return self

    def clear_branch_introduction(self):
        self.common_actions.click_element(*self.brand_locators.BRANCH_INTRODUCTION_IN_BRANCH_BRAND_INFO_PAGE)
        self.common_actions.click_element(*self.brand_locators.CLEAR_BRANCH_INTRODUCTION_BUTTON_IN_BRANCH_BRAND_INFO_PAGE)
        self.common_actions.click_element(*self.brand_locators.CONFIRM_BRANCH_INTRODUCTION_BUTTON_IN_BRANCH_BRAND_INFO_PAGE)
        return self

    def verify_branch_introduction_empty(self):
        self.common_actions.is_element_visible(*self.brand_locators.BRANCH_INTRODUCTION_IN_BRANCH_BRAND_INFO_PAGE)
        self.common_actions.verify_element_text(*self.brand_locators.BRANCH_INTRODUCTION_IN_BRANCH_BRAND_INFO_PAGE, "")
        return self
    ...
    def verify_branch_introduction(self, branch_introduction):
    ...
    def verify_branch_phone_number(self, country_code, phone_number):
        self.common_actions.verify_element_text(*self.brand_locators.BRANCH_PHONE_COUNTRY_CODE_IN_BRANCH_BRAND_INFO_PAGE, country_code)
    ...
    def verify_branch_address(self, branch_city, branch_district, branch_address):
