...
class ServicePersonnelPage:
    ...
    def tap_service_personnel_button(self):
        self.common_actions.wait_for_element_visible(*self.service_personnel_page_locators.SERVICE_PERSONNEL_BUTTON_IN_BRANCH_SETTINGS_PAGE)
    ...
    def enter_service_personnel_introduction(self, service_personnel_introduction):
        ...
        self.common_actions.wait_for_element_disappear(*self.service_personnel_page_locators.SERVICE_PERSONNEL_INTRODUCTION_FIELD)
        return self
    ...
    def enter_simultaneous_service_count(self, simultaneous_service_count):
        ...
        self.common_actions.scroll_to_element(*self.service_personnel_page_locators.SIMULTANEOUS_SERVICE_COUNT_FIELD_IN_SERVICE_PERSONNEL_MODAL)
