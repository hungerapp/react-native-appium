...
def select_service(driver):
    create_page = CreateAppointmentPage(driver)
    common_use = CommonUseSection(driver)
    create_page.click_service()
    common_use.select_service()
    
@when('I change service time and service person')
def change_service_time_and_service_person(driver):
    create_page = CreateAppointmentPage(driver)
    create_page.change_service_time_and_service_person()
    

@when('I select a valid appointment time')
def select_appointment_time(driver):
    create_page = CreateAppointmentPage(driver)
    create_page.select_appointment_time()
    
@when('I input the note in the note section')
...
@when('I click one more service button')
def click_one_more_service(driver):
    create_page = CreateAppointmentPage(driver)
    create_page.click_one_more_service()

@when('I change the reservation time and add one more service')
def change_reservation_time(driver):
    create_page = CreateAppointmentPage(driver)
    create_page.select_appointment_time()
    create_page.one_more_service()
 
@when('I choose which deposit should be selected')    
...
@when('I add one more service')
def add_one_more_service(driver):
    create_page = CreateAppointmentPage(driver)
    create_page.click_one_more_service()
    
@when('I delete one service')
...
def go_back_to_calendar(driver):
    create_page = CreateAppointmentPage(driver)
    create_page.left_before_complete_appointment()
...
@when(parsers.parse('I fill in the contact with existing name "{name}" and phone "{phone}" number'))
def fill_existing_contact(driver, name, phone):
    create_page = CreateAppointmentPage(driver)
    create_page.fill_existing_contact(name, phone)
    
@when('I check the member passport and back')
...
@when(parsers.parse('I enter an invalid phone number "{phone}"'))
def enter_invalid_phone(driver, phone):
    create_page = CreateAppointmentPage(driver)
    create_page.enter_phone_number(phone)
...
@when(parsers.parse('I enter a partial phone number "{phone_number}"'))
def enter_partial_phone(driver, phone_number):
    create_page = CreateAppointmentPage(driver)
    create_page.enter_phone_number(phone_number)

@when('I click the phone search button for partial phone number')
...
@when(parsers.parse('I enter a full phone number "{phone_number}"'))
def enter_full_phone(driver, phone_number):
    create_page = CreateAppointmentPage(driver)
    create_page.enter_phone_number(phone_number)

@when('I click the phone search button for full phone number')
...
@when(parsers.parse('I enter a partial name "{name}"'))
def enter_partial_name(driver, name):
    create_page = CreateAppointmentPage(driver)
    create_page.enter_name(name)

@when('I click the name search button for partial name')
...
@when(parsers.parse('I enter a full name "{name}"'))
def enter_full_name(driver, name):
    create_page = CreateAppointmentPage(driver)
    create_page.enter_name(name)

@when('I click the name search button for full name')
